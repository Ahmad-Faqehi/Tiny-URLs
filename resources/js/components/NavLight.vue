            ...
            <div class="container relative flex flex-wrap items-center justify-between">
                <a class="navbar-brand md:me-8" href="/">
                    <span class="inline-block dark:hidden">
                        <img src="../assets/images/a-logo-dark.png" class="l-dark" alt="">
                        <img src="../assets/images/a-logo-white.png" class="l-light" alt="">
                    </span>
                    <img src="../assets/images/a-logo-white.png" class="hidden dark:inline-block" alt="">
                </a>
